...
public class BlockVoxelShapes {
    ...
    public static final List<VoxelShape> playerHeadShape = Arrays.asList(Block.box(4, 0, 4, 12, 8, 12));


    public static final List<VoxelShape> slabBottomShape = Arrays.asList(Block.box(0.0D, 0.0D, 0.0D, 16.0D, 8.0D, 16.0D));
    public static final List<VoxelShape> smallChairShape = Arrays.asList(Block.box(0.0D, 0.0D, 0.0D, 16.0D, 6.0D, 16.0D));

    public static final List<VoxelShape> pillarShape = Arrays.asList(Block.box(6.0D, 0.0D, 6.0D, 10.0D, 16.0D, 10.0D));

    public static final List<VoxelShape> pillarShape2 = Arrays.asList(Block.box(4, 0, 4, 12, 16, 12));
    ...
    public static final List<VoxelShape> clothesHangarShape = Arrays.asList(
    ...
    public static final List<VoxelShape> shelfShape = makeNSEWShapes(
            Block.box(0.0D, 12.0D, 6.0D, 16.0D, 16.0D, 16.0D)
    );

    public static final List<VoxelShape> doorKnocker = makeNSEWShapes(
            Block.box(4.0D, 4.0D, 13.0D, 12.0D, 12.0D, 16.0D)
    );

    public static final List<VoxelShape> mirrorShape = makeNSEWShapes(
            Block.box(2.0D, 0.0D, 13.0D, 14.0D, 16.0D, 16.0D)
    );

    public static final List<VoxelShape> broomShape = makeNSEWShapes(
            Block.box(6.0D, 0.0D, 7.0D, 10.0D, 16.0D, 16.0D)
    );

    public static final List<VoxelShape> paneShape = makeNSEWShapes(
            Block.box(0.0D, 0.0D, 6.0D, 16.0D, 16.0D, 10.0D)
    );
    ...
    public static final List<VoxelShape> bellowsShape = makeNSEWShapes(
    ...
    public static final List<VoxelShape> spinningWheelShape = makeNSEWShapes(
            Block.box(0.0D, 0.0D, 3.0D, 16.0D, 16.0D, 13.0D)
    );

    public static final List<VoxelShape> cabinetShape = makeNSEWShapes(
            Block.box(0.0D, 0.0D, 6.0D, 16.0D, 16.0D, 16.0D)
    );



    public static final List<VoxelShape> smallCorniceCornerShape = Arrays.asList(
            Shapes.or(Block.box(0.0D, 0.0D, 8.0D, 8.0D, 8.0D, 16.0D), Block.box(8.0D, 0.0D, 0.0D, 16.0D, 8.0D, 16.0D)),
            Shapes.or(Block.box(0.0D, 0.0D, 0.0D, 8.0D, 8.0D, 16.0D), Block.box(8.0D, 0.0D, 0.0D, 16.0D, 8.0D, 8.0D)),
            Shapes.or(Block.box(0.0D, 0.0D, 8.0D, 16.0D, 8.0D, 16.0D), Block.box(0.0D, 0.0D, 0.0D, 8.0D, 8.0D, 8.0D)),
            Shapes.or(Block.box(0.0D, 0.0D, 0.0D, 16.0D, 8.0D, 8.0D), Block.box(8.0D, 0.0D, 8.0D, 16.0D, 8.0D, 16.0D)),
            Shapes.or(Block.box(0.0D, 8.0D, 8.0D, 8.0D, 16.0D, 16.0D), Block.box(8.0D, 8.0D, 0.0D, 16.0D, 16.0D, 16.0D)),
            Shapes.or(Block.box(0.0D, 8.0D, 0.0D, 8.0D, 16.0D, 16.0D), Block.box(8.0D, 8.0D, 0.0D, 16.0D, 16.0D, 8.0D)),
            Shapes.or(Block.box(0.0D, 8.0D, 8.0D, 16.0D, 16.0D, 16.0D), Block.box(0.0D, 8.0D, 0.0D, 8.0D, 16.0D, 8.0D)),
            Shapes.or(Block.box(0.0D, 8.0D, 0.0D, 16.0D, 16.0D, 8.0D), Block.box(8.0D, 8.0D, 8.0D, 16.0D, 16.0D, 16.0D))
    );

    public static final List<VoxelShape> smallCorniceQuarterShape = Arrays.asList(
    ...
    public static final List<VoxelShape> halfCauldronShape1 = Arrays.asList(Shapes.join(Block.box(0.0D, 0.0D, 0.0D, 15.0D, 8.0D, 15.0D), Block.box(2.0D, 4.0D, 2.0D, 14.0D, 16.0D, 14.0D), BooleanOp.ONLY_FIRST));


    public static List<VoxelShape> makeNSEWShapes(VoxelShape shape) {
        return Arrays.asList(shape, rotateShape(Direction.EAST, shape), rotateShape(Direction.SOUTH, shape), rotateShape(Direction.WEST, shape));
    }
