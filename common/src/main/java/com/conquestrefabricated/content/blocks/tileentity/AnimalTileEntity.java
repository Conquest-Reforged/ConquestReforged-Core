...
*/
    ...
    private static void checkBlockAddParticle(AnimalParticleData[] animalParticles, double xpos, double ypos, double zpos, Level level, BlockState state) {
        if (state.getBlock() instanceof Animal.Bird && state.getValue(Animal.Bird.FLYING)) {
    ...
    private static void addAnimalParticle(AnimalParticleData animal, double xpos, double ypos, double zpos, Level level) {
        for (int i = 0; i < 2; i++) {
            level.addParticle(animal, true, false, xpos, ypos, zpos, 0, 0, 0);
        }
    }

    public static void particleTickServer (Level level, BlockPos blockPos, BlockState state, AnimalTileEntity blockEntity) {
        if (level.isClientSide()) {
            double xpos = blockPos.getX() + 0.5;
            double ypos = blockPos.getY() + 0.5;
            double zpos = blockPos.getZ() + 0.5;
            ...
            switch(state.getBlock().toString()) {
                case "Block{conquest:raven}":
                    checkBlockAddParticleServer(ravenParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:hawk}":
                    checkBlockAddParticleServer(hawkParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:bat}":
                    checkBlockAddParticleServer(batParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:bluejay}":
                    checkBlockAddParticleServer(bluejayParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:duck}":
                    checkBlockAddParticleServer(duckParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:owl}":
                    checkBlockAddParticleServer(owlParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:pigeon}":
                    checkBlockAddParticleServer(pigeonParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:puffin}":
                    checkBlockAddParticleServer(puffinParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:seagull}":
                    checkBlockAddParticleServer(seagullParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:toad}":
                    checkBlockAddParticleServer(toadParticles, xpos, ypos, zpos, level, state);
                    break;
                case "Block{conquest:rat}":
                    checkBlockAddParticleServer(ratParticles, xpos, ypos, zpos, level, state);
                    break;
            }
    ...
    private static void checkBlockAddParticleServer(AnimalParticleData[] animalParticles, double xpos, double ypos, double zpos, Level level, BlockState state) {
        if (state.getBlock() instanceof Animal.Bird && state.getValue(Animal.Bird.FLYING)) {
            switch (state.getValue(Animal.TOGGLE)) {
                case 1:
                    addAnimalParticleServer(animalParticles[4], xpos, ypos, zpos, level);
                    break;
                case 2:
                    addAnimalParticleServer(animalParticles[5], xpos, ypos, zpos, level);
                    break;
                case 3:
                    addAnimalParticleServer(animalParticles[6], xpos, ypos, zpos, level);
                    break;
                case 4:
                    addAnimalParticleServer(animalParticles[7], xpos, ypos, zpos, level);
                    break;
            }
        } else {
            switch (state.getValue(Animal.TOGGLE)) {
                case 1:
                    addAnimalParticleServer(animalParticles[0], xpos, ypos, zpos, level);
                    break;
                case 2:
                    addAnimalParticleServer(animalParticles[1], xpos, ypos, zpos, level);
                    break;
                case 3:
                    addAnimalParticleServer(animalParticles[2], xpos, ypos, zpos, level);
                    break;
                case 4:
                    addAnimalParticleServer(animalParticles[3], xpos, ypos, zpos, level);
                    break;
            }
        }
    }

    private static void addAnimalParticleServer(AnimalParticleData animal, double xpos, double ypos, double zpos, Level level) {
        if (level instanceof ServerLevel server) {
            for (int i = 0; i < 2; i++) {
                server.sendParticles(animal, xpos, ypos, zpos, 2, 0, 0, 0, 0);
            }
        }
    }
}