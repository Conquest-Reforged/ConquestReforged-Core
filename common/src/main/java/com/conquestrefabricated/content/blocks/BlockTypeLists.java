...
public class BlockTypeLists {
    ...
    public static TypeList refinedStoneCobbleBrickShapesMinimal = refinedStoneCobbleBrickShapes.removeAll(ArchSmall.class, ArchSmallHalf.class, ArchTwoMeter.class, ArchTwoMeterHalf.class, ArrowSlit.class, WindowSmall.class, WindowSmallHalf.class, Balustrade.class, Capital.class, Sphere.class);
