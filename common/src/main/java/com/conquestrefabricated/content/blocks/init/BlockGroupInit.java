...
public class BlockGroupInit {
    ...
    public static void init() {
        ...
        //register(ModGroups.GRASSES_AND_SHRUBS, BuiltInRegistries.BLOCK.get(Identifier.parse("conquest:duckweed")).get().value());
        register(ModGroups.GRASSES_AND_SHRUBS, Blocks.LILY_PAD);
        //register(ModGroups.GRASSES_AND_SHRUBS, BuiltInRegistries.BLOCK.get(Identifier.parse("conquest:big_water_lilies")).get().value());
        ...
        //register(ModGroups.WATER_AND_AIR, BuiltInRegistries.BLOCK.get(Identifier.parse("conquest:floating_ice")).get().value());
        //ANIMALS
    ...
    private static void register(CreativeModeTab group, Block... blocks) {
