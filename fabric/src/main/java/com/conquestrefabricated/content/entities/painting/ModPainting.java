...
public class ModPainting implements Translateable, Painting {
    ...
    private static final Identifier ITEM = Identifier.fromNamespaceAndPath("conquest", "painting");
    ...
    private ModPainting(String name) {
        this.name = name;
        this.texture = Identifier.fromNamespaceAndPath("conquest", "textures/entity/painting/" + name + ".png");
    }
